...
namespace Hilvilla {
    ...
    public class Detalles : ReportClass {
    ...
    public class CachedDetalles : Component, ICachedReport {
        
        public CachedDetalles() {
        }
